package committee.nova.ore_tree.common.config;
...
public class OTCommonConfig {
    ...
    static {
        final var COMMON_BUILDER = new ForgeConfigSpec.Builder();
        ...
        CAN_PLANT_ON_DIRT = COMMON_BUILDER.comment("Could ore trees be planted on dirts?").define("dirtable", false);

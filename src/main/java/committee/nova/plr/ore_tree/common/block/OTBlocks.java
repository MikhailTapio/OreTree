...
import static committee.nova.plr.ore_tree.common.OreTree.N;
import static committee.nova.plr.ore_tree.common.OreTree.OreTree;

public class OTBlocks {
    public static final TagKey<Block> QUARTZ_ORES = TagKey.of(Registry.BLOCK_KEY, new Identifier("quartz_ores"));

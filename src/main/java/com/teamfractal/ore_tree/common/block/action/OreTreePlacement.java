package com.teamfractal.ore_tree.common.block.action;
...
public class OreTreePlacement {
    ...
    private static boolean isTargetBlockReplaceable(BlockState block) {
        return block.isIn(BlockTags.LEAVES)
                || block.isIn(BlockTags.SAPLINGS)
                || block.getBlock() instanceof AirBlock;
    }
}
